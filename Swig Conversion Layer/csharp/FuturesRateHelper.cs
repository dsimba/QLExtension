...
public class FuturesRateHelper : RateHelper {
  ...
  public FuturesRateHelper(QuoteHandle price, Date immDate, IborIndex index, QuoteHandle convexityAdjustment) : this(NQuantLibcPINVOKE.new_FuturesRateHelper__SWIG_4(QuoteHandle.getCPtr(price), Date.getCPtr(immDate), IborIndex.getCPtr(index), QuoteHandle.getCPtr(convexityAdjustment)), true) {
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
  }

  public FuturesRateHelper(double price, Date immDate, IborIndex index, double convexityAdjustment) : this(NQuantLibcPINVOKE.new_FuturesRateHelper__SWIG_5(price, Date.getCPtr(immDate), IborIndex.getCPtr(index), convexityAdjustment), true) {
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
  }

  public FuturesRateHelper(double price, Date immDate, IborIndex index) : this(NQuantLibcPINVOKE.new_FuturesRateHelper__SWIG_6(price, Date.getCPtr(immDate), IborIndex.getCPtr(index)), true) {
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
  }
