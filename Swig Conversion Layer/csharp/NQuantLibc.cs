...
public class NQuantLibc {
  ...
  public static void uniformthreefry(int seed, int skip, double[] buffer1, int length) {
    NQuantLibcPINVOKE.uniformthreefry(seed, skip, buffer1, length);
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
  }

  public static void normalthreefry(int seed, int skip, double[] buffer2, int length) {
    NQuantLibcPINVOKE.normalthreefry(seed, skip, buffer2, length);
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
  }

  public static void gammathreefry(int seed, int skip, double[] buffer3, int length, double shape, double scale) {
    NQuantLibcPINVOKE.gammathreefry(seed, skip, buffer3, length, shape, scale);
    if (NQuantLibcPINVOKE.SWIGPendingException.Pending) throw NQuantLibcPINVOKE.SWIGPendingException.Retrieve();
  }
