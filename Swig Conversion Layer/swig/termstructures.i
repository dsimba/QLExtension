...
%ignore CommodityCurveExt;
class CommodityCurveExt : public Extrapolator {
	public:
...
%template(CommodityCurveExt) boost::shared_ptr<CommodityCurveExt>;
%extend boost::shared_ptr<CommodityCurveExt> {
	boost::shared_ptr<CommodityCurveExt>(const std::string name,		// e.g. commod ng exchange
                       ...
                       const DayCounter& dayCounter)
	{
		return new boost::shared_ptr<CommodityCurveExt>(
            new CommodityCurveExt(name, dates, prices, calendar, dayCounter));
	}            
}
IsObservable(boost::shared_ptr<CommodityCurveExt>);

%template(CommodityCurveExtHandle) Handle<CommodityCurveExt>;
IsObservable(Handle<CommodityCurveExt>);
%template(RelinkableCommodityCurveExtHandle)
RelinkableHandle<CommodityCurveExt>;
